...
parameters = ['Input CSV Directory', 'Output CSV Directory', 'Trace CSV Directory',
'DC Supply A Output 1 Voltage', 'DC Supply A Output 1 Current Limit', 'DC Supply A Output 1 Over-Voltage Limit', 
'DC Supply A Output 2 Voltage', 'DC Supply A Output 2 Current Limit', 'DC Supply A Output 2 Over-Voltage Limit', 
...
'Resolution Bandwidth','Sweep Points','Sweep Time (seconds)','Auto-Detector (OFF:0 / ON:1)','Manual-Detector (AVG/SAMP)','Vertical-Scale (LOG/LIN)', 'Internal Pre-Amp (OFF:0 / ON:1)',
'Reference Level','Auto-Attenuation (OFF:0 / ON:1)','Manual Attenuation','Center Freq','Span','Auto-Resolution Bandwidth (OFF:0 / ON:1)', 'Auto-Video Bandwidth (OFF:0 / ON:1)',
'Resolution Bandwidth','Sweep Points','Sweep Time (seconds)','Auto-Detector (OFF:0 / ON:1)','Manual-Detector (AVG/SAMP)','Vertical-Scale (LOG/LIN)', 'Internal Pre-Amp (OFF:0 / ON:1)']

defaults = ['C:\\Users\\HSY210000\\Downloads\\inputs', 'C:\\Users\\HSY210000\\Downloads\\outputs', 'C:\\Users\\HSY210000\\Downloads\\traces',
'0.5', '100e-3', '2',
'1', '100e-3', '2', 
'0.5', '1.1', '100e-3', 
'2','5.001e9', '-90', '5e9', '-90', 'LOG', '100', '1e-3', '5.0001e9', '-130', 
...
# Defining the entry fields (50 fields necessary)
# Parameter indexes 0-13: Column 1, 13-22: Column 2, 22-36: Column 3, 36:50 Column 4

idx_ranges = ((0,13),(13,22),(22,36),(36,50))
label_col = 0
entry_col = 1
